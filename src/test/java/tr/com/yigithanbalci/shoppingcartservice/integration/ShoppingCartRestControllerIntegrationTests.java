...
public class ShoppingCartRestControllerIntegrationTests {
  ...
  public void testShoppingCart(){
    Topping milk = Topping.builder().id(1L).name("Milk").price(2.0f).build();
    Topping hazelnutSyrup = Topping.builder().id(2L).name("Hazelnut syrup").price(2.0f).build();
    Topping lemon = Topping.builder().id(3L).name("Lemon").price(2.0f).build();

    Drink blackCoffee = Drink.builder().id(1L).name("Black Coffee").price(4.0f).build();
    Drink latte = Drink.builder().id(2L).name("Latte").price(4.0f).build();
    Drink tea = Drink.builder().id(3L).name("Tea").price(3.0f).build();
